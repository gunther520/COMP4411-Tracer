...
{
	((TraceUI*)(o->user_data()))->m_nAttenuationConstant=(((Fl_Slider *)o)->value());
}

void TraceUI::cb_linearAttenuationSlides(Fl_Widget* o, void* v)
{
	((TraceUI*)(o->user_data()))->m_nLinearAttenuation=(((Fl_Slider *)o)->value());
}
...
TraceUI::TraceUI() {
	...
	m_mainWindow = new Fl_Window(100, 40, 320, 200, "Ray <Not Loaded>");
		...
		m_attenuationConstant = new Fl_Value_Slider(10, 80, 180, 20, "Constant Attenuation");
		m_attenuationConstant->user_data((void*)(this));	// record self to be used by static callback functions
		m_attenuationConstant->type(FL_HOR_NICE_SLIDER);
		m_attenuationConstant->labelfont(FL_COURIER);
		m_attenuationConstant->labelsize(12);
		...
		// linear attenuation
		 m_linearAttenuation = new Fl_Value_Slider(10, 105, 180, 20, "Linear Attenuation");
		 ...
		 m_quadraticAttenuation = new Fl_Value_Slider(10, 130, 180, 20, "Quadratic Attenuation");
